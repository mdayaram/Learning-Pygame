    ...
    while True:
        ...
        if boxx is not None and boxy is not None:
            ...
            if not revealedBoxes[boxx][boxy] and mouseClicked:
                ...
                if firstSelection is None:  # current box was clicked first
                    firstSelection = (boxx, boxy)
                else:  # current box was clicked second
...
def gameWonAnimation(board):
    ...
    global BGCOLOR, LIGHTBGCOLOR
    BGCOLOR0, LIGHTBGCOLOR0 = BGCOLOR, LIGHTBGCOLOR
    # color1 = LIGHTBGCOLOR
    # color2 = BGCOLOR

    for i in range(13):
        # color1, color2 = color2, color1  # swap colors
        BGCOLOR, LIGHTBGCOLOR = LIGHTBGCOLOR, BGCOLOR
        DISPLAYSURF.fill(BGCOLOR)
        drawBoard(board, coveredBoxes)
        pygame.display.update()
        pygame.time.wait(300)

    BGCOLOR, LIGHTBGCOLOR = BGCOLOR0, LIGHTBGCOLOR0
    DISPLAYSURF.fill(BGCOLOR)


def hasWon(revealedBoxes):
    # Returns True if all the bores have been revealed, otherwise False
